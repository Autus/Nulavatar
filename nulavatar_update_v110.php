...
$file = "nulavatar_update_v110.php";
$na_version = "1.1.0";
...
$dat[] = 'Updating Settings table';
$sql[] = "INSERT INTO `".$table_prefix."nulavatar_settings` (config_name,config_value,config_type,config_isradio,config_radio_choices) VALUES ('rpgsystem','moogies','rpgmod','1','moogies,adr')";
$dat[] = 'Updating Settings table';
